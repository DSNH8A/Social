  ...
  return (
    <div className="flex w-full">
      <Form {...form}>
        ...
        className="flex flex-col gap-9 w-full max-w-5xl h-full">
            <FormField
            ...
            render={({field}) =>(
               <FormItem>
                    ...
                    <FormControl>
                        <Textarea className="shad-textarea custom-scrollbar" {...field}></Textarea>
                    </FormControl>
            ...
            render={({field}) =>(
               <FormItem>
                    <FormLabel className="shad-form_label"> Add photos
                    </FormLabel>
                    <FormControl>
            ...
            render={({field}) =>(
               <FormItem>
                    <FormLabel className="shad-form_label"> Add location
                    </FormLabel>
                    <FormControl>
